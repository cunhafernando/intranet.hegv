...
ActiveRecord::Schema[7.0].define(version: 2022_09_30_132923) do
  ...
  create_table "comentarios", force: :cascade do |t|
    t.text "body"
    t.bigint "noticia_id", null: false
    t.bigint "user_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["noticia_id"], name: "index_comentarios_on_noticia_id"
  ...
  create_table "ramais", force: :cascade do |t|
    t.string "setor"
    t.string "telefone"
    t.string "email"
    ...
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false
    t.index ["user_id"], name: "index_ramais_on_user_id"
  end
  ...
  create_table "useres_roles", id: false, force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "role_id"
    t.index ["role_id"], name: "index_useres_roles_on_role_id"
    t.index ["user_id", "role_id"], name: "index_useres_roles_on_user_id_and_role_id"
    t.index ["user_id"], name: "index_useres_roles_on_user_id"
  end

  add_foreign_key "active_storage_attachments", "active_storage_blobs", column: "blob_id"
  add_foreign_key "active_storage_variant_records", "active_storage_blobs", column: "blob_id"
  add_foreign_key "comentarios", "noticias"
  add_foreign_key "comentarios", "useres"
  add_foreign_key "jornais", "useres"
  add_foreign_key "noticias", "categorias"
  add_foreign_key "noticias", "useres"
  add_foreign_key "ramais", "useres"
end
