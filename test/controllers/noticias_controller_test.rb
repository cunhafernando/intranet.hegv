...
class NoticiasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create noticia" do
    assert_difference("Noticia.count") do
      post noticias_url, params: { noticia: { arquivo: @noticia.arquivo, texto: @noticia.texto, titulo: @noticia.titulo } }
    end
  ...
  test "should update noticia" do
    patch noticia_url(@noticia), params: { noticia: { arquivo: @noticia.arquivo, texto: @noticia.texto, titulo: @noticia.titulo } }
